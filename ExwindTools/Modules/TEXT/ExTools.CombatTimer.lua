        ...
        cards = {
            ...
            },
            {
                ...
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "leftText", label = L["前缀文字 (左)"], labelPos = "top", type = "input", w = 46, x = 1, y = 1 },
                        { h = 6, key = "rightText", label = L["后缀文字 (右)"], labelPos = "top", type = "input", w = 46, x = 51, y = 1 },
                    },
                },
            },
            {
