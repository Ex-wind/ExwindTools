...
local MODULE_SPEC = {
    ...
    gui = {
        ...
        cards = {
            ...
            {
                id = "interrupt-rules", title = L["打断条件"],
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "hideWhenNotInterruptible", label = L["|cffff080a隐藏不能打断的条 (隐藏钢条)|r"], type = "checkbox", w = 46, x = 1, y = 1 },
                        { h = 6, key = "nonInterruptColor", label = L["无法打断颜色"], type = "color", w = 46, x = 51, y = 1 },
                        { h = 6, key = "hideOnInterruptCD", label = L["打断CD时隐藏可断条"], type = "checkbox", w = 46, x = 1, y = 13 },
                        { h = 6, key = "showInterruptCDThreshold", label = L["打断CD剩余几秒时显示(左边颜色)"], max = 10, min = 0, type = "slider", w = 46, x = 51, y = 13 },
                        { h = 6, key = "interruptCDColor", label = L["打断CD时颜色"], type = "color", w = 46, x = 101, y = 13 },
                        { h = 6, key = "muteSoundOnInterruptCD", label = L["打断CD时不播放音效"], type = "checkbox", w = 46, x = 151, y = 13 },
                    },
                },
            },
            {
                id = "interrupt-marker", title = L["打断冷却标线"],
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "showInterruptMarkerLine", label = L["显示打断冷却标线"], type = "checkbox", w = 46, x = 1, y = 1 },
                        { h = 6, key = "interruptMarkerColor", label = L["标线颜色"], type = "color", w = 46, x = 51, y = 1 },
                        { h = 6, key = "interruptMarkerWidth", label = L["标线粗细"], max = 16, min = 1, step = 1, type = "slider", w = 46, x = 101, y = 1 },
                    },
                },
            },
            {
                id = "sound", title = L["提示音设置"],
                content = {
                    kind = "composite", component = "soundgroup", key = "alert",
                    opts = {
                        secondaryCheckbox = { key = "alertHostileOnly", label = L["仅敌方单位"] },
