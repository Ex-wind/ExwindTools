...
for _, instance in ipairs(EXDB.InstanceNoteInstanceSource) do
    local challengeModeID = tonumber(instance.challengeModeID) or 0
    if challengeModeID > 0 then
        DEFAULT_MAP_NAMES[challengeModeID] = instance.zhCNShort
    end
end
