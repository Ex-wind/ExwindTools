...
local MODULE_SPEC = {
    ...
    gui = {
        ...
        cards = {
            {
                id = "general", title = L["酒池基础设置"],
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "enabled", label = L["启用酒池条"], type = "checkbox", w = 46, x = 4, y = 1 },
                        { h = 6, key = "showText", label = L["显示文字"], type = "checkbox", w = 46, x = 54, y = 1 },
                        { h = 6, key = "hideBar", label = L["隐藏条体"], type = "checkbox", w = 46, x = 104, y = 1 },
                        { h = 6, key = "hideOnMounted", label = L["骑乘时隐藏"], type = "checkbox", w = 46, x = 154, y = 1 },
                        { h = 6, key = "textColorFollowsBar", label = L["文字跟随条体颜色"], type = "checkbox", w = 46, x = 4, y = 11 },
                        { h = 6, key = "textValueOnly", label = L["仅显示数值"], type = "checkbox", w = 46, x = 54, y = 11 },
                        { h = 6, key = "fullBarPercent", label = L["满条映射上限 (%)"], max = 500, min = 50, step = 1, type = "slider", w = 46, x = 104, y = 11 },
                        { h = 6, key = "btn_reset_pos", label = L["重置酒池位置"], type = "button", w = 46, x = 154, y = 11 },
                    },
                },
            },
            {
            ...
            {
                id = "thresholds", title = L["酒池数值与阈值"],
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "warningEnabled", label = L["启用"], type = "checkbox", w = 46, x = 4, y = 1 },
                        { h = 6, key = "warningThresholdValue", label = L["阶段一(%)"], type = "input", w = 46, x = 54, y = 1 },
                        { h = 6, key = "warningColor", label = L["阶段一颜色"], type = "color", w = 46, x = 104, y = 1 },
                        { h = 6, key = "dangerEnabled", label = L["启用"], type = "checkbox", w = 46, x = 4, y = 11 },
                        { h = 6, key = "dangerThresholdValue", label = L["阶段二(%)"], type = "input", w = 46, x = 54, y = 11 },
                        { h = 6, key = "dangerColor", label = L["阶段二颜色"], type = "color", w = 46, x = 104, y = 11 },
                        { h = 6, key = "extraColor1Enabled", label = L["启用"], type = "checkbox", w = 46, x = 4, y = 21 },
                        { h = 6, key = "extraColor1ThresholdValue", label = L["阶段三(%)"], type = "input", w = 46, x = 54, y = 21 },
                        { h = 6, key = "extraColor1", label = L["阶段三颜色"], type = "color", w = 46, x = 104, y = 21 },
                        { h = 6, key = "extraColor2Enabled", label = L["启用"], type = "checkbox", w = 46, x = 4, y = 31 },
                        { h = 6, key = "extraColor2ThresholdValue", label = L["阶段四(%)"], type = "input", w = 46, x = 54, y = 31 },
                        { h = 6, key = "extraColor2", label = L["阶段四颜色"], type = "color", w = 46, x = 104, y = 31 },
                    },
                },
            },
            {
                id = "timerbar", title = L["酒池条样式"],
                content = { kind = "composite", component = "timerbargroup", key = "timerGroup" },
            },
            {
                id = "text", title = L["酒池文字样式"],
