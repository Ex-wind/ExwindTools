...
local MODULE_SPEC = {
    ...
    gui = {
        ...
        cards = {
            {
                id = "general", title = L["模块通用设置"],
                content = {
                    kind = "composite", component = "modulecommonsettings", key = "moduleCommon",
                    opts = {
                        bindRoot = true,
                        fields = {
            ...
            {
                id = "layout", title = L["排列设置"],
                content = {
                    kind = "composite", component = "widgetlayout", key = "layout",
                    opts = {
                        allowedDirections = { "RIGHT", "LEFT", "UP", "DOWN", "CENTER_HORIZONTAL", "CENTER_VERTICAL" },
                        defaultMaxVisible = 8, includeMaxPerRow = false, maxVisibleMax = 20, maxVisibleMin = 1,
                    },
                },
            },
            {
            ...
            },
            {
                ...
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "ignoreSpellId", label = L["法术ID"], labelPos = "top", type = "input", w = 46, x = 3, y = 1 },
                        { h = 6, key = "btn_addIgnore", label = L["添加/移除"], type = "button", w = 46, x = 53, y = 1 },
                        { h = 6, key = "btn_showIgnore", label = L["显示列表"], type = "button", w = 46, x = 103, y = 1 },
                        { h = 6, key = "btn_clearIgnore", label = L["清空列表"], type = "button", w = 46, x = 153, y = 1 },
                    },
                },
            },
        },
