...
local MODULE_SPEC = {
    ...
    gui = {
        version = 1,
        title = L["嗜血音效（YY Sound）"],
        cards = {
            {
                id = "general", title = L["通用显示"],
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "enabled", label = L["启用"], type = "checkbox", w = 46, x = 2, y = 1 },
                        { h = 6, key = "spellID", label = L["法术 ID（优先）"], labelPos = "top", type = "input", w = 70, x = 51, y = 1 },
                        { h = 6, key = "iconTexture", label = L["图标路径/ID"], labelPos = "top", type = "input", w = 70, x = 125, y = 1 },
                    },
                },
            },
            {
            ...
            },
            {
                ...
                content = {
                    ...
                    items = {
                        ...
                        { h = 6, key = "useCustomSound", label = L["使用自定义路径"], type = "checkbox", w = 46, x = 2, y = 10 },
                        { h = 6, key = "randomSound", label = L["随机播放多条"], type = "checkbox", w = 46, x = 51, y = 10 },
                    },
                },
            },
            {
                ...
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "customSound1", label = L["音效 1"], labelPos = "left", parentKey = "customSounds", subKey = "1", type = "input", w = 180, x = 15, y = 1 },
                        { h = 6, key = "customSound2", label = L["音效 2"], labelPos = "left", parentKey = "customSounds", subKey = "2", type = "input", w = 180, x = 15, y = 9 },
                        { h = 6, key = "customSound3", label = L["音效 3"], labelPos = "left", parentKey = "customSounds", subKey = "3", type = "input", w = 180, x = 15, y = 17 },
                        { h = 6, key = "customSound4", label = L["音效 4"], labelPos = "left", parentKey = "customSounds", subKey = "4", type = "input", w = 180, x = 15, y = 25 },
                        { h = 6, key = "customSound5", label = L["音效 5"], labelPos = "left", parentKey = "customSounds", subKey = "5", type = "input", w = 180, x = 15, y = 33 },
                        { h = 6, key = "customSound6", label = L["音效 6"], labelPos = "left", parentKey = "customSounds", subKey = "6", type = "input", w = 180, x = 15, y = 41 },
                    },
                },
            },
            {
                id = "test", title = L["测试操作"],
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "btn_test", label = L["测试效果"], type = "button", w = 46, x = 15, y = 1 },
                        { h = 6, key = "btn_stop", label = L["停止测试"], type = "button", w = 46, x = 65, y = 1 },
                    },
                },
            },
        },
