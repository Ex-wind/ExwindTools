        ...
        cards = {
            ...
            },
            {
                ...
                content = {
                    kind = "grid",
                    items = {
                        { h = 6, key = "enterMessage", label = L["进入战斗文本"], labelPos = "top", type = "input", w = 92, x = 3, y = 1 },
                        { h = 6, key = "leaveMessage", label = L["离开战斗文本"], labelPos = "top", type = "input", w = 92, x = 103, y = 1 },
                        { h = 6, key = "enterColor", label = L["进入战斗颜色"], type = "color", w = 46, x = 3, y = 11 },
                        { h = 6, key = "leaveColor", label = L["离开战斗颜色"], type = "color", w = 46, x = 53, y = 11 },
                    },
                },
            },
            {
                id = "text", title = L["文字样式"],
